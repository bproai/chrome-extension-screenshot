...
var Whiteboard = function Whiteboard() {
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_1__.useEffect)(function () {
    ...
    canvas.width = window.innerWidth - 40; // Padding for aesthetics
      ...
      var _loop = function _loop() {
        ...
        if (item.type.indexOf('image') !== -1) {
          ...
          img.onload = function () {
            ...
            var canvas = canvasRef.current;
            var scale = Math.min((canvas.width - 40) / img.width, (canvas.height - 40) / img.height);
...
//# sourceMappingURL=whiteboard.67e89ed1b61492e4a2dd.js.map